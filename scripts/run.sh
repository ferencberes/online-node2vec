...
python evaluate.py "lazy_decayedTrue-secondorder_hl43200_numh20_modhash200000_in0.00_out1.00_incrTrue-onlinew2v_dim128_lr0.0100_neg20_uratio0.80_square_mirrorTrue_omFalse_inituniform_expW1True_i86400_tnFalse_win2_pairsTrue" $SAMPLES $THREADS $MAX_DAYS