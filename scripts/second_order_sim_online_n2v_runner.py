...
from online_n2v.walk_sampling import OnlineSecondOrderSim
...
updater = OnlineSecondOrderSim(half_life=half_life, num_hash=hash_num, hash_generator=hash_gen, real_direction=False)
